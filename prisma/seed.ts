...
const demoEvents = [
  {
    ...
    attendees: [
      ...
      { email: "maya.singh@example.com", name: "Maya Singh", type: "candidate", rsvp: "ACCEPTED" },
    ],
  },
  {
    iCalUID: "demo-maya-portfolio@wiggli.local",
    summary: "Portfolio review with Maya Singh",
    eventType: "Candidate interview",
    ...
    attendees: [{ email: "maya.singh@example.com", name: "Maya Singh", type: "candidate", rsvp: "NEEDS_ACTION" }],
  },
  {
